...
const Actions = ({ filter, filterFiles, onFullWidth, onOptions, onClose }) => (
  <div className='actions'>
    ...
    <div className='actions-small-button'>
      <button onClick={onFullWidth} className='__better_github_pr_full_width' title='Toggle maximum width of github content'>
        <img
    ...
    <div className='actions-small-button'>
      <button onClick={onOptions} className='settings_button'>
